...
export const HROUTES: RouteInfo[] = [
  { path: '/pages/dashboard', title: 'Dashboard', icon: 'ft-home', class: 'dropdown nav-item', isExternalLink: false, submenu: [] },
  { path: '/pages/restaurants/list', title: 'Branches', icon: 'ft-map-pin', class: 'dropdown nav-item', isExternalLink: false, submenu: [] },
  { path: '/pages/users/list', title: 'Users', icon: 'ft-users', class: 'dropdown nav-item', isExternalLink: false, submenu: [] },
  { path: '/pages/categories/list', title: 'Categories', icon: 'ft-layers', class: 'dropdown nav-item', isExternalLink: false, submenu: [] },
  { path: '/pages/products/list', title: 'All Menu', icon: 'ft-grid', class: 'dropdown nav-item', isExternalLink: false, submenu: [] },
  { path: '/pages/variations/list', title: 'Variations', icon: 'ft-repeat', class: 'dropdown nav-item', isExternalLink: false, submenu: [] },
  { path: '/pages/tables/list', title: 'Tables', icon: 'ft-table', class: 'dropdown nav-item', isExternalLink: false, submenu: [] },
  { path: '/pages/table-booking/list', title: 'Table Booking', icon: 'ft-calendar', class: 'dropdown nav-item', isExternalLink: false, submenu: [] },
  { path: '/pages/orders/list', title: 'Orders', icon: 'ft-shopping-cart', class: 'dropdown nav-item', isExternalLink: false, submenu: [] },
  { path: '/pages/invoices/list', title: 'Invoices', icon: 'ft-file-text', class: 'dropdown nav-item', isExternalLink: false, submenu: [] },
  { path: '/pages/messages/list', title: 'Messages', icon: 'ft-message-circle', class: 'dropdown nav-item', isExternalLink: false, submenu: [] },
  { path: '/pages/coupons/list', title: 'Coupons', icon: 'ft-tag', class: 'dropdown nav-item', isExternalLink: false, submenu: [] }
  /*
  {
    path: '', title: 'Dashboard', icon: 'ft-home', class: 'dropdown nav-item', isExternalLink: false,
    submenu: [
